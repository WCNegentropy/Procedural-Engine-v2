...
- **Python Test Suite**: `pytest tests/unit/test_ui_system.py::TestImGuiBackend::test_begin_end_frame tests/unit/test_ui_system.py::TestImGuiBackend::test_works_with_ui_manager tests/unit/test_player_controller.py::TestInputManager::test_mouse_button` → 3 passed in 0.15s
- **Notes**:
